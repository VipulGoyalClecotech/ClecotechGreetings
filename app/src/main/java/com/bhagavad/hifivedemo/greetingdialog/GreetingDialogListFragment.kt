package com.bhagavad.hifivedemo.greetingdialog
...
import com.bhagavad.hifivedemo.country.dialogItemSelectedInterface


class GreetingDialogListFragment : DialogFragment(), dialogItemSelectedInterface {

    private val TAG = GreetingDialogListFragment::class.java.simpleName

    private var mSearchView: SearchView? = null
    lateinit var mDataArrList: ArrayList<UsersAndGreetingListResponse.GreetingData>
    ...
    private var mDialogAdapter: GreetingDialogListAdapter? = null
    ...
    private lateinit var mNewList: ArrayList<UsersAndGreetingListResponse.GreetingData>
    ...
    * */
    interface OnDialogClickedListener {
        fun onDialogYes()
        fun onDialogNo()
        fun selectedDialogItem(dialogPos: Int, selectedData: UsersAndGreetingListResponse.GreetingData)
    }
    ...
    * */
    public fun getList(): ArrayList<UsersAndGreetingListResponse.GreetingData> {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mContext = activity
        Log.e("isCountryPopup--->", "showing")
        mDataArrList = ArrayList<UsersAndGreetingListResponse.GreetingData>()
       ...
       // mOkBtn = rootView.findViewById<View>(R.id.btn_ok) as Button
        ...
        mDialogAdapter = GreetingDialogListAdapter(activity!!, this)
        ...
        if (arguments!!.getParcelableArrayList<Parcelable>("country-list") != null) {
            mDataArrList =
                (arguments!!.getSerializable("country-list") as ArrayList<UsersAndGreetingListResponse.GreetingData>?)!!
       ...
       /* mOkBtn.setOnClickListener {
        ...
        mNewList = ArrayList<UsersAndGreetingListResponse.GreetingData>()
    ...
    companion object {
        internal lateinit var mDialogListFragment: GreetingDialogListFragment
        //    private ImageView mCrossIv;

        fun newInstance(
            title: String,
            arrList: ArrayList<UsersAndGreetingListResponse.GreetingData>, placeHolder: String
        ): GreetingDialogListFragment {
            mDialogListFragment = GreetingDialogListFragment()
            val bundle = Bundle()
