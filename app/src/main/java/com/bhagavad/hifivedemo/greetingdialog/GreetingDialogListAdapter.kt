...
class GreetingDialogListAdapter(
    private val mContext: Context,
    internal var dialogListener: dialogItemSelectedInterface
) : RecyclerView.Adapter<GreetingDialogListAdapter.ViewHolder>() {

    private var TAG = GreetingDialogListAdapter::class.java.simpleName
    private lateinit var mDataArr: ArrayList<UsersAndGreetingListResponse.GreetingData>
    ...
    fun setList(optArr: ArrayList<UsersAndGreetingListResponse.GreetingData>) {
        mDataArr = ArrayList<UsersAndGreetingListResponse.GreetingData>()
        mDataArr = optArr
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding!!.tvCode.setText("" + model.id)
